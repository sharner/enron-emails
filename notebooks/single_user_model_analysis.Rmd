...
# email.addr <- "steven.kean@enron.com" # 6759 emails
...
If this is any indication, the percentages of characters distinguish these people.  We see for example that day of the week probably isn't important.  The percentage of [a-z] characters, time of day, etc., is important.

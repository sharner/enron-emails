...
Use the LDA algorithm to do a topic analysis, in which each author corresponds to a topic (ideally).  The Beta matrix is the probability that a term was generated from a topic.
